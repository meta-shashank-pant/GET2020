...
public class EmployeeLinkedList {
	...
	/**
	 * It will insert an employee object on linked list.
	 * @param employee is the object of type employee.
	 */
	...
	public void printList(EmployeeLinkedList list) {
		String empList[] = list.getEmplyeeList();
